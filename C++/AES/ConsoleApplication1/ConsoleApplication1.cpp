...
void MixColumns()
{
	...
	for (i = 0; i<4; i++)
	{
		state[i][0] = (state[i][0] * '2') ^ (state[i][1] * '3') ^ (state[i][2] * '1') ^ (state[i][3] * '1');
		state[i][0] = (state[i][0] * '1') ^ (state[i][1] * '2') ^ (state[i][2] * '3') ^ (state[i][3] * '1');
		state[i][0] = (state[i][0] * '1') ^ (state[i][1] * '1') ^ (state[i][2] * '2') ^ (state[i][3] * '3');
		state[i][0] = (state[i][0] * '3') ^ (state[i][1] * '1') ^ (state[i][2] * '1') ^ (state[i][3] * '2');
	}
}
